// copy form https://github.com/shadowsocks/shadowsocks-windows and modify.
    ...
    public class PrivoxyRunner/* : IEnableLogger*/
    {
        ...
        public PrivoxyRunner()
        {
            try
            {
                ...
                _uid = System.Windows.Forms.Application.StartupPath.GetHashCode();
            ...
            catch (IOException e)
            {
                ...
                v2rayN.Utils.SaveLog("An error occurred while starting Privoxy.", e);
                _uniqueConfigFile = "";
            }
        }
        ...
        public void Start(/*NetSettings netSettings*/string listen_address, int listen_port, string forward_address, int forward_port)
        {
            if (_process == null)
            {
                //Process[] existingPrivoxy = Process.GetProcessesByName("ss_privoxy");
                Process[] existingPrivoxy = Process.GetProcessesByName("v2rayN_privoxy");
                ...
                privoxyConfig = privoxyConfig.Replace("__SOCKS_PORT__", forward_port.ToString());
                v2rayN.Utils.FileManager.ByteArrayToFile(v2rayN.Utils.GetTempPath(_uniqueConfigFile), Encoding.UTF8.GetBytes(privoxyConfig));
        ...
        private void KillProcess(Process p)
        {
            ...
            catch (Exception e)
            {
                ...
                v2rayN.Utils.SaveLog("An error occurred while stopping Privoxy.", e);
            }
        }
        ...
        private bool IsChildProcess(Process process)
        {
            try
            {
                ...
                return v2rayN.Utils.GetTempPath("v2rayN_privoxy.exe").Equals(path);
            ...
            catch (Exception ex)
            {
                 ...
                 */
                //this.Log().Error(ex, "");
                v2rayN.Utils.SaveLog(ex.Message, ex);
                return false;
            }
        }
